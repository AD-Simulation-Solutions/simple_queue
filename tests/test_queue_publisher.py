...
class TestQueuePublisher:
    ...
    def test_init_sets_attributes(self):
        ...
        publisher = QueuePublisher(
            queue_name, uri, queue_size, retry_times, retry_delay
        )
    ...
    def test_setup_queue_creates_queue_and_exchange(
        self, mock_exchange_class, mock_queue_class
    ):
        ...
        mock_queue.declare.assert_called_once()
    ...
    @patch("simple_queue.core.rabbitpy.Exchange")
    def test_push_dict_message_success(self, mock_exchange_class, mock_message_class):
        ...
        # Verify publish
        mock_message.publish.assert_called_once_with(
            mock_exchange, "test_queue", mandatory=True
        )
    ...
    @patch("simple_queue.core.rabbitpy.Message")
    @patch("simple_queue.core.rabbitpy.Exchange")
    def test_push_list_message_success(self, mock_exchange_class, mock_message_class):
    ...
    @patch("simple_queue.core.rabbitpy.Message")
    @patch("simple_queue.core.rabbitpy.Exchange")
    def test_push_string_message_success(self, mock_exchange_class, mock_message_class):
    ...
    @patch("simple_queue.core.rabbitpy.Message")
    @patch("simple_queue.core.rabbitpy.Exchange")
    def test_push_publish_fails(self, mock_exchange_class, mock_message_class):
    ...
    def test_push_retries_on_exception(
        self, mock_sleep, mock_exchange_class, mock_message_class
    ):
